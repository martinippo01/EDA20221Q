...
//________________________________________QUERY BUILDER_________________________________________________________________
            //Aca tengo mi Query builder
            String queryStr= "content:gam*";

            // Con el query parser, indico como quiero que se proccese mi query builder
            QueryParser queryparser = new QueryParser(null, new StandardAnalyzer() );
            // Creo la query en si, parseando el texto que con el querybuilder
